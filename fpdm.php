...
/**
 * Plugin Name: FPDM
 * Plugin URI:  http://www.fpdf.org/en/script/script93.php
 * Description: PDF generator plugin
 * Version: 2.0.1
 * Author: KavyaSagar
 */
 ...
 */
if ( !defined( 'FPDM_INSTALL_PATH' ) ) {                
    define( 'FPDM_INSTALL_PATH', dirname(__FILE__).'/' );
}

//Major stream filters come from FPDI's stuff but I've added some :)
require_once(FPDM_INSTALL_PATH. "filters/FilterASCIIHex.php");
require_once(FPDM_INSTALL_PATH. "filters/FilterASCII85.php");
require_once(FPDM_INSTALL_PATH. "filters/FilterFlate.php");
require_once(FPDM_INSTALL_PATH. "filters/FilterLZW.php");
require_once(FPDM_INSTALL_PATH. "filters/FilterStandard.php");
		...
		**/
		...
		//-----------------------------------
			...
			if($this->support == "pdftk") {
				...
				require_once(FPDM_INSTALL_PATH. "lib/url.php"); //we will need a url support because relative urls for pdf inside fdf files are not supported by PDFTK...
				require_once(FPDM_INSTALL_PATH. "export/fdf/fdf.php"); //...conjointly with my patched/bridged forge_fdf that provides fdf file generation support from array data. 
				require_once(FPDM_INSTALL_PATH. "export/pdf/pdftk.php");//Of course don't forget to bridge to PDFTK!
